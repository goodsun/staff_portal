...
if (!fs_1.default.existsSync(ASSET_ROOT))
    fs_1.default.mkdirSync(ASSET_ROOT, { recursive: true });
const assetUpload = (0, upload_1.makeAssetUploader)(UPLOAD_DIR);
...
router.get('/', auth_1.requireAuth, (req, res) => {
    ...
    const entries = fs_1.default.readdirSync(full).map(name => {
        ...
        const kind = isDir ? 'other' : getKind(name);
